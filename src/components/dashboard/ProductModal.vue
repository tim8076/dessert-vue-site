        ...
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-4">
              ...
              <img class="img-fluid" :alt="tempProduct.title" v-if="tempProduct.imageUrl" :src="tempProduct.imageUrl">
              <!-- 延伸技巧，多圖 -->
              <div class="mt-5">
            ...
            <div class="col-sm-8">
              ...
              <div class="row gx-2">
                ...
                <div class="mb-3 col-md-6">
                  ...
                  <input type="text" class="form-control" id="unit" placeholder="請輸入單位" v-model.trim="tempProduct.unit">
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea type="text" class="form-control" id="description" placeholder="請輸入產品描述"
                  v-model.trim="tempProduct.description"></textarea>
              </div>
              <div class="mb-3">
                <label for="content" class="form-label">說明內容</label>
                <textarea type="text" class="form-control" id="content" placeholder="請輸入產品說明內容"
                  v-model.trim="tempProduct.content"></textarea>
              </div>
              <div class="mb-3">
